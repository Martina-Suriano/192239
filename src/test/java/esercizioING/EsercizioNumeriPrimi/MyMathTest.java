package esercizioING.EsercizioNumeriPrimi;
...
public class MyMathTest 
{
    ...
    public void primeNumbersGeneratorWorks() {
    	//inserendo un numero minore di due(input) deve restituire una lista vuota (valore atteso)
    ...
    public void isPrimeWorks() {
    	...
    	//inserendo un numero <2 l'output atteso è falso
